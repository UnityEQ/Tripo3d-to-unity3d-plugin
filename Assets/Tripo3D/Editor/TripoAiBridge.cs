    ...
    internal static class TripoAiBridge
    {
        ...
        static string BuildPrompt(string glb, string slug, string outDir)
        {
            ...
            return
                ...
                "3. Skin / bone weights: follow **§4 of the Modular standard**. Heat (`ARMATURE_AUTO`) is a first pass only. Then isolate opposite-limb / finger / remote leak, paint 3–5-loop joint bands while posing elbows/knees/shoulders/crotch at ~90°, then clean 0.01 → limit 4 → normalize. Do not add twist bones, Preserve Volume, or Corrective Smooth — Unity Humanoid is 52-bone linear blend, four influences. A heat bind that still spikes at 90° is not done.\n" +
