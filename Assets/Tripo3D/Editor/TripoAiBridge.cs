    ...
    internal static class TripoAiBridge
    {
        ...
        static string BuildPrompt(string glb, string slug, string outDir)
        {
            ...
            return
                ...
                "   - `SwordSlash` — one-shot one-handed sword slash, 24–36 frames, **not** looping. Use **Hand.R** as if gripping a one-handed sword: wind-up, slash across the body, follow-through, recover. Do **not** create a sword mesh unless one already exists. Left arm may counterbalance. Fingers in a grip on the right hand.\n" +
                "   Watch the standard's reversed-knee-pole bake failure: inspect axial bone orientation, not just joint endpoints. Keep rest skeleton and weights unchanged while authoring clips.\n" +
                ...
                "Reuse line: Read the Modular Biped Humanoid Rig Standard v1 and its reference JSON. Rig this character using biped_humanoid_v1: identical core names and hierarchy, calibrated matrix transforms, modular anatomy fitting, full fingers, verified skin weights, then author Idle, Run, Jump, and SwordSlash, and a baked skinned export with those clips. Preserve the working Blender rig and report validation results.\n";
        }
